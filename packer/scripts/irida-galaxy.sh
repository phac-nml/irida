...
docker pull phacnml/galaxy-irida-17.01:0.21.0
docker run --name galaxy -d -p 9090:80 -v /home/irida/data/sequencing:/home/irida/data/sequencing phacnml/galaxy-irida-17.01:0.21.0
...
ExecStart=/usr/bin/docker run --name galaxy -d -p 9090:80 -v /home/irida/data/sequencing:/home/irida/data/sequencing phacnml/galaxy-irida-17.01:0.21.0
