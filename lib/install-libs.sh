...
mvn --settings maven-central-secure-settings.xml install:install-file -Dfile=dandelion-core-1.1.1-IRIDA.jar -DgroupId=com.github.dandelion -DartifactId=dandelion-core -Dversion=1.1.1-IRIDA -Dpackaging=jar -DgeneratePom=true -DcreateChecksum=true
