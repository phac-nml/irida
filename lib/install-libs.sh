...
mvn --settings maven-central-secure-settings.xml install:install-file -Dfile=cisd-jhdf5.jar -DgroupId=ch.systems.cisd -DartifactId=jhdf5 -Dversion=13.06.2 -Dpackaging=jar -DgeneratePom=true -DcreateChecksum=true
