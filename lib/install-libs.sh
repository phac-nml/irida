...
mvn --settings maven-central-secure-settings.xml install:install-file -Dfile=blend4j-0.2.1-2201df9.jar -DpomFile=blend4j-0.2.1-2201df9.pom -DcreateChecksum=true
