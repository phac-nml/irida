...
* [REST]: Removed broken XML serialization objects from REST API classes.  It was breaking content negotiation for some tools as it sometimes tried to return XML when it couldn't.
