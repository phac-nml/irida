...
- [UI]: Fixed a bug where the `hashCode` method on `SequenceFilePair` was _only_ using the date the pair was created, causing `Set`s of pairs to be much smaller than expected. (1.0.3)
