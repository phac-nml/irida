...
public class GenomeAssemblyRemoteServiceImpl extends RemoteServiceImpl<UploadedAssembly> implements GenomeAssemblyRemoteService {
    ...
    public GenomeAssembly mirrorSequencingObject(UploadedAssembly seqObject) {
