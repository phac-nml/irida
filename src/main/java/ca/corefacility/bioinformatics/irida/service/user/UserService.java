...
public interface UserService extends CRUDService<Long, User>, UserDetailsService {
	 ...
	 *
	 * @param email The email address to read a user for
	 * @return The user with the given email address
	 * @throws EntityNotFoundException If no user has the given email address
	 */
	 ...
	 *
	 * @param project the project to get users for
	 * @param search  the string to filter on
	 ...
	 *
	 * @param project The {@link Project} to count {@link User}s for.
	 ...
	 * @param filter  the search string to filter usernames on.
	 ...
	 * @return A Collection of {@code Join<Project,User>}s that have the given role
	 */
	public Collection<Join<Project, User>> getUsersForProjectByRole(Project project, ProjectRole projectRole);

	/**
	 * Update a {@link ProjectUserJoin} to subscribe or unsubscribe a {@link User} to a given {@link Project}
	 *
	 * @param user       the {@link User} to subscribe
	 * @param project    the {@link Project} to subscribe to
	 * @param subscribed whether to subscribe or unsubscribe the user
	...
	/**
	 * Change the password on the {@link User} account. This method may be called by a fully-authenticated {@link User},
	 * or by a {@link User} who is
	 * <i>NOT</i> fully-authenticated and {@link User#isCredentialsNonExpired()}
	 * returns <code>false</code>.
	 *
	 * @param userId   the identifier of the account to change the password for.
	...
	/**
	 * Get list of {@link GenericStatModel} of users created in the past n time period grouped by the format provided.
	 *
	 * @param createdDate         the minimum date for users created
