...
public class AnnouncementServiceImpl extends CRUDServiceImpl<Long, Announcement> implements AnnouncementService {
	...
	public AnnouncementServiceImpl(AnnouncementRepository announcementRepository,
			AnnouncementUserJoinRepository announcementUserJoinRepository, UserRepository userRepository,
			Validator validator) {
	...
	public void markAnnouncementAsUnreadByUser(Announcement announcement, User user) throws EntityNotFoundException {
		...
		try {
			final AnnouncementUserJoin join = announcementUserJoinRepository.getAnnouncementUserJoin(announcement,
					user);
			Long id = join.getId();
