 ...
 */
public class CRUDServiceImpl<KeyType extends Identifier, ValueType extends Comparable<ValueType> & Auditable<Audit>> implements CRUDService<KeyType, ValueType> {
     ...
     */
    @Override
    public ValueType update(KeyType id, Map<String, Object> updatedFields) throws ConstraintViolationException, EntityExistsException, InvalidPropertyException {
        ...
        // set the date that the entity was updated on
