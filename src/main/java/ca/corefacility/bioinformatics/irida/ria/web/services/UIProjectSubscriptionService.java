...
public class UIProjectSubscriptionService {
    ...
    @Autowired
    public UIProjectSubscriptionService(ProjectSubscriptionService projectSubscriptionService, UserService userService, ProjectService projectService) {
     ...
     */
    public TableResponse<UserProjectDetailsModel> getProjectSubscriptionsForUser(Long userId, TableRequest tableRequest) {
