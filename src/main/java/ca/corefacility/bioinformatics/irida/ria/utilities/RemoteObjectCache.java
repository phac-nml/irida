...
/**
 * In memory cache for storing {@link IridaResourceSupport}s with a retrievable
 * identifier. This will specifically be used when a {@link IridaResourceSupport}
 * object needs to be displayed in a form on a page and must be able to be
 * selected by a user.
 * 
 *
 * @param <Type>
 *            The type of {@link IridaResourceSupport} to store
 */
@Component
...
public class RemoteObjectCache<Type extends IridaResourceSupport> {
	 ...
	 * 
	 * @param resource
	 *            The {@link IridaResourceSupport} to add
	 * @param api
