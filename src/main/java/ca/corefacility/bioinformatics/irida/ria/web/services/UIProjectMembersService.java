...
public class UIProjectMembersService {
    ...
    public TableResponse<ProjectMemberTableModel> getProjectMembers(Long projectId, TableRequest tableRequest) {
        ...
        Page<Join<Project, User>> usersForProject = userService.searchUsersForProject(project, tableRequest.getSearch(), tableRequest.getCurrent(), tableRequest.getPageSize(), tableRequest.getSort());
        List<ProjectMemberTableModel> members = usersForProject.get().map(join -> {
            ProjectUserJoin projectUserJoin = (ProjectUserJoin) join;
            return new ProjectMemberTableModel(join.getObject(), projectUserJoin.getProjectRole().toString(), ((ProjectUserJoin) join).getMetadataRole().toString(), projectUserJoin.getCreatedDate());
    ...
    public String removeUserFromProject(Long projectId, Long userId, Locale locale) throws UIProjectWithoutOwnerException {
        ...
        try {
            ...
            return messageSource.getMessage("server.RemoveMemberButton.success", new Object[]{user.getUsername()}, locale);
        } catch (ProjectWithoutOwnerException e) {
            throw new UIProjectWithoutOwnerException(messageSource.getMessage("server.RemoveMemberButton.error", new Object[]{user.getUsername()}, locale));
        }
    ...
    public String updateUserRoleOnProject(Long projectId, Long userId, String role, Locale locale) throws UIProjectWithoutOwnerException, UIConstraintViolationException {
        ...
        try {
            ...
            return messageSource.getMessage("server.update.projectRole.success", new Object[]{user.getLabel(), roleString}, locale);
        } catch (ProjectWithoutOwnerException e) {
    ...
    public String updateUserMetadataRoleOnProject(Long projectId, Long userId, String metadataRole, Locale locale) {
        ...
        return messageSource.getMessage("server.update.metadataRole.success", new Object[]{user.getLabel(), roleString}, locale);
