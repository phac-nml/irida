...
public class GalaxySearch {
	 ...
	 * @param email
	 *            The email of the user to search.
	 * @return A User object of the user with the corresponding email, or null
	 *         if no such user.
	 */
	 ...
	 * @return A Library object for this Galaxy library, or null if no such
	 *         library.
	 */
	 ...
	 *         LibraryContent object, or null if no library exists.
	 */
	 ...
	 * @return A list of Library objects matching the given name, empty if no
	 *         matching libraries are found.
	 */
