...
public class SequencingObjectConcatenatorFactory {
	 ...
	 * @param iridaFileStorageService The file storage component
	 * @return the new {@link SequencingObjectConcatenator}
	 */
	@SuppressWarnings("unchecked")
	public static <T extends SequencingObject> SequencingObjectConcatenator<T> getConcatenator(Class<T> type, IridaFileStorageService iridaFileStorageService) {

		// return the concatenator for the class
		if (type.equals(SingleEndSequenceFile.class)) {
			return (SequencingObjectConcatenator<T>) new SingleEndSequenceFileConcatenator(iridaFileStorageService);
		} else if (type.equals(SequenceFilePair.class)) {
			return (SequencingObjectConcatenator<T>) new SequenceFilePairConcatenator(iridaFileStorageService);
		} else {
	...
	public static SequencingObjectConcatenator<? extends SequencingObject> getConcatenator(
			Collection<? extends SequencingObject> objects, IridaFileStorageService iridaFileStorageService) {
		...
		return getConcatenator(type, iridaFileStorageService);
	}
}
