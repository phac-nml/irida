...
/**
 * Hibernate validator to validate if a user/usegroup is a manager on a project then their metadata role
 * should be set to the highest level. Otherwise if a user/usergroup is a collaborator on a project
 * then their metadata role can be any of the levels (must not be null).
 */
