...
/**
 * Validation annotation to validate that if the projectRole is set to PROJECT_OWNER
 * for a user/usergroup then the metadataRole must be set to the highest level
