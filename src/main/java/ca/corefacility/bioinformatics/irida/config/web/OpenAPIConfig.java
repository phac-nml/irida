...
@SecurityScheme(
        ...
        flows = @OAuthFlows(authorizationCode = @OAuthFlow(authorizationUrl = "/api/oauth/authorize", tokenUrl = "/api/oauth/token",
...
@OpenAPIDefinition(
        ...
        tags = {@Tag(name = "api", description = "Access to API details"),
