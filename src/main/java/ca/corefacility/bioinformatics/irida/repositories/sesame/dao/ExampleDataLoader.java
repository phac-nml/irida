...
public class ExampleDataLoader {
    ...
    public ExampleDataLoader(UserRepository userRepo, ProjectRepository projRepo, RelationshipRepository relationshipRepo,PasswordEncoder passwordEncoder) {
    ...
    public void addSampleData() {
        User tom = userRepo.create(new User("tom", "tom@nowhere.com", passwordEncoder.encode("PASSWOD!1"), "Tom", "Matthews", "1234"));
        User franklin = userRepo.create(new User("franklin", "franklin@nowhere.com", passwordEncoder.encode("PASSWOD!2"), "Franklin", "Bristow", "2345"));
        User josh = userRepo.create(new User("joshX", "josh@nowhere.com", passwordEncoder.encode("PASSWOD!3"), "Josh", "Adam", "3456"));
        ...
        for (int i = 1; i <= 100; i++) {
            ...
            User u = userRepo.create(new User("user" + i, "user" + i + "@nowhere.com", "PASSWOD!" + i, "User", "Number" + i,
                    i + "04-123-4567"));
