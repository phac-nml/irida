...
public interface SampleRepository extends IridaJpaRepository<Sample, Long>, SampleRepositoryCustom {
	 ...
	 * @param sampleNames A {@link List} of {@link String} sample names
	 * @param pageable    {@link Pageable} information about which {@link Sample}s to retrun
	...
	/**
	 * Get the {@link Sample}s associated with a given {@link AnalysisSubmission}
	 *
	...
	/**
	 * Get a list of {@link GenericStatModel}s for samples created in the past n time period and grouped by the format
	 * provided.
	 *
	 * @param createdDate   The minimum created date for samples
