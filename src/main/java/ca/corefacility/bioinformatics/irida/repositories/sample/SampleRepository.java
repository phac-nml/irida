...
public interface SampleRepository extends IridaJpaRepository<Sample, Long> {
	 ...
	 * @param pageable
	 * 		{@link Pageable} information about which {@link Sample}s to retrun
	 *
	...
	public Page<ProjectSampleJoin> findSampleByNameInProject(Project project, List<String> sampleNames, Pageable pageable);
}
