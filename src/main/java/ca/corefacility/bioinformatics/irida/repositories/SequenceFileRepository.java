 ...
 * This repository will not directly store the file, just metadata
...
public interface SequenceFileRepository extends CRUDRepository<Long, SequenceFile>{
     ...
     *
     * @param project The project to get the files for
     ...
     *
     * @param sample The sample to get the files for
     ...
     * @param sample The sample to add to
     * @param file The file to add to the project
     ...
     * @param project The project to remove the file from
     ...
     * @param sample The sample to remove the file from
     * @param file The file to remove
     */    
