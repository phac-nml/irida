...
/**
 * A repository to store information about sequence files. This repository will not directly store the file, just
 * metadata
 */
public interface SequenceFileRepository
		extends FilesystemSupplementedRepository<SequenceFile>, IridaJpaRepository<SequenceFile, Long> {
	/**
	 * {@inheritDoc}
	 * <p>
