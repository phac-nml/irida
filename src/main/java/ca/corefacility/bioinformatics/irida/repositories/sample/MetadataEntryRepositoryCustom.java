...
public interface MetadataEntryRepositoryCustom {
	...
	/**
	 * Get all the {@link MetadataEntry} for a subset of samples in a given project.
	 *
	 * @param project   the {@link Project} to get metadata for.
	 * @param sampleIds the {@link Sample} ids to get metadata for.
	 * @param fields    the fields to get metadata from in the project. This must not be emtpy.
	 * @return The Map of the Project's metadata.
	 */
	Map<Long, Set<MetadataEntry>> getMetadataForSamplesInProject(Project project, List<Long> sampleIds,
