...
public class RemoteSequenceFilePair implements IridaSequenceFilePair, IridaThing {
	...
	@Size(min = 2, max = 2)
	@CollectionTable(name = "remote_sequence_file_pair_files", joinColumns = @JoinColumn(name = "pair_id"), uniqueConstraints = @UniqueConstraint(columnNames = { "files_id" }, name = "UK_SEQUENCE_FILE_PAIR"))
	private Set<RemoteSequenceFile> files;

	public RemoteSequenceFilePair() {
