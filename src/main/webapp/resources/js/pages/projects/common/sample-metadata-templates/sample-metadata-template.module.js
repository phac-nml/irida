...
export const SampleMetadataTemplateModule = angular
  .module("irida.samples.metadata.template", ["ngResource"])
  .directive("metadataTemplateName", metadataTemplateName)
  .service("SampleMetadataTemplateService", SampleMetadataTemplateService).name;
