/**
 * Component to render a div for text output
 */
...
/**
 * Stateless UI component for displaying a div for text output
 *
 * @param {number} height - Height of div. Default is 300px
 * @param {string} description - Optional description
 * @param {object} children - content to display in div
 * @param {object} props - any other attributes to add to TextOutputWrapper
 *
 * @returns {Element} - Returns a scrollable div component
 */

export function TextOutputWrapper({ height = 300, children, ...props }) {
