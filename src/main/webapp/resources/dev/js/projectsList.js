/* global angular */
var app = angular.module('irida.projectsList', ['ajaxService']);
...
var ProjectsListCtrl = app.controller('ProjectsListCtrl', ['$scope', '$location', 'ajaxService', function ($scope, $location, ajaxService) {
  'use strict';
