...
public class IridaWorkflowTestBuilder {
	...
	public static IridaWorkflowDescription buildTestDescription(UUID id, String name, String version,
		...
		switch (input) {
		case SINGLE:
			workflowInput = new IridaWorkflowInput("sequence_reads", null, null, reference, requiresSingleSample);
			break;
		case PAIRED:
			workflowInput = new IridaWorkflowInput(null, "sequence_reads_paired", null, reference,
					requiresSingleSample);
			break;
		case SINGLE_PAIRED:
			workflowInput = new IridaWorkflowInput("sequence_reads", "sequence_reads_paired", null, reference,
					requiresSingleSample);
			break;
		case GENOME_ASSEMBLIES:
			workflowInput = new IridaWorkflowInput(null, null, "genome_assemblies", reference, requiresSingleSample);
		}
