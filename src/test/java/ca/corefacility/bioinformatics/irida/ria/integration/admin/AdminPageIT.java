...
public class AdminPageIT extends AbstractIridaUIITChromeDriver {
	...
	public void accessPageAsAdmin() {
		...
		assertTrue("Create New User button should be present", page.adminAddUserVisible());
	...
	public void testPageSetUp() {
		...
		assertTrue("Admin statistics link should be visible", page.adminStatisticsLinkVisible());
