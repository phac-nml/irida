 ...
 */
public class FTPClientNCBITestConnectionSpeed {
	
	/**
	 * NCBI FTP connectiond details
	 * Please create an account with NCBI and go to <https://submit.ncbi.nlm.nih.gov/subs/sra/>, selecting the option to enable FTP upload.
	 * Then fill out your details here.
	 */
	...
	private static final String NCBI_FTP_PASSWORD = "[PASSSWORD]";
	 ...
	 */
	private static final Path file = Paths.get("/tmp/1MB"); 
	...
	public static void main(String[] args) throws SocketException, IOException {		
		...
		if (!success) {
			...
			System.out.println(String.format("Uploaded file [%s] %.2f MB in %.2f seconds (%.2f MB/s), using sendDataSocketBufferSize [%i]", file, sizeMB, timeSeconds, rateMBS, ftp.getSendDataSocketBufferSize()));
		}
	}
}
