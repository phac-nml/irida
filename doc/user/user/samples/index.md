...
1. By enabling the assembly pipeline as an [automated pipelines](../project/#automated-pipelines), which will be triggered on upload of sequencing files in the appropriate project.
