...
2. **Threads used for file processing (FastQC, GZip, etc):**
  ...
  * `file.processing.max.size=8` - The maximum number of available threads for file processing.  This number shuold not exceed the configured maximum number of JCBC threads.
