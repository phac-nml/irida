...
* The [SISTR](https://irida.corefacility.ca/documentation/administrator/galaxy/pipelines/sistr/) has been updated from 0.3.0 to 0.3.1 and will require updating the Shovill tool in Galaxy.
